...
#Add a search/query function for the database
        self.frame_search = Frame(self.frame_OptionMaster,width=50,bg="blue")
        self.label_search_title = Label(self.frame_search,text="Search")
        self.label_search_building = Label(self.frame_search,text="Building/Class: ")
        self.entry_search_building = Entry(self.frame_search)
        self.label_search_num = Label(self.frame_search,text="Number: ")
        self.entry_search_num = Entry(self.frame_search)

        self.label_search_title.grid(row=1,columnspan=2)
        self.label_search_building.grid(row=2,column=1)
        self.entry_search_building.grid(row=2,column=2)
        self.label_search_num.grid(row=3,column=1)
        self.entry_search_num.grid(row=3,column=2)       
...
#Add Event(class) options outside of file
        ...
        self.frame_search.grid(column=2)
        self.frame_addRoom.grid(column=3)
        self.frame_addEvent.grid(column=4)
